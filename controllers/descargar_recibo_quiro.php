...
if (!$quiro) die("Personal no encontrado.");
...
foreach ($servicios as $s) {
    ...
    $pdf->SetXY($x + 55, $y + 1);
    // Agregamos la tasa y también la comisión exacta del servicio en texto
...
$pdf->SetTextColor(13, 110, 253); // Letra Verde
// Quitamos el "(40%)" porque ya es variable
...
$pdf->Output('I', 'Recibo_Comision_' . $quiro['cedula_id'] . '.pdf');
?>