...
<body class="bg-light m-0 p-0 d-flex flex-column" style="height: 100vh; overflow: hidden;">
    ...
    <div class="d-flex flex-grow-1" style="min-height: 0; overflow: hidden;">
        ...
        <div class="flex-grow-1 p-4" style="overflow-y: auto; background-color: #f8f9fa;">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-8">
                    <div class="card border-0 shadow-sm card-registro-alto p-3 p-md-4" style="border-left: 8px solid #0d6efd !important;">
                        <div class="card-body d-flex flex-column flex-md-row align-items-center justify-content-between text-center text-md-start gap-3">
                            ...
                            <a href="gestion_pacientes/pacientes.php" class="btn btn-primary btn-lg px-4 mt-2 mt-md-0 w-100 w-md-auto">Registrar paciente</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-md-10 col-lg-8 text-center">
                    <span class="badge bg-white text-secondary border px-4 py-3 fs-6 shadow-sm w-100" style="border-radius: 15px;">
